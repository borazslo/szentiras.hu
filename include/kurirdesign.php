...
echo "    }\n";
echo "}\n";
echo "function ujablak(lap){\n";
echo "  ablak = open(lap, \"Keres-info\",\n";
echo "    \"width=400,height=250,status=no,menubar=no,directories=no,location=no,toolbar=no\");\n";
echo "}\n";
echo "\n";
echo "// -->\n";
echo "</SCRIPT>\n";
...
echo"        <tr>\n";
echo"          <td>\n";
echo"          <img src='/img/logo-kurir1.jpg' width='690' height='108' align='middle' alt='Logo'>\n";
echo"          </td></tr></table>\n";
echo"      </td>\n";
echo"   </tr>\n";
echo"   </table>\n";
...
echo "<TABLE WIDTH=209 BORDER=0 CELLPADDING=0 CELLSPACING=0>\n";
echo "    <TR>\n";
...
echo "        <TD>\n";
# echo "            <A HREF=\"/admin\"\n";
# echo "                ONMOUSEOVER=\"changeImages('nav_hor_02', '/img/nav_hor_02-over.gif'); return true;\"\n";
# echo "                ONMOUSEOUT=\"changeImages('nav_hor_02', '/img/nav_hor_02.gif'); return true;\">\n";
# echo "                <IMG NAME=\"nav_hor_02\" SRC=\"/img/nav_hor_02.gif\" WIDTH=18 HEIGHT=20 BORDER=0></A></TD>\n";
# echo "        <TD>\n";
...
# echo "        <TD>\n";
# echo "            <A HREF=\"http://www.katolikus.hu/keres.html\"\n";
...
# echo "        <TD>\n";
# echo "            <A HREF=\"http://www.communio.hu/plebania/tarsalgo/tarsalgo.htm\"\n";
# echo "                ONMOUSEOVER=\"changeImages('nav_hor_04', '/img/nav_hor_04-nav_hor_05_over.gif', 'nav_hor_05', '/img/nav_hor_05-over.gif'); return true;\"\n";
# echo "                ONMOUSEOUT=\"changeImages('nav_hor_04', '/img/nav_hor_04.gif', 'nav_hor_05', '/img/nav_hor_05.gif'); return true;\">\n";
# echo "                <IMG NAME=\"nav_hor_05\" SRC=\"/img/nav_hor_05.gif\" WIDTH=43 HEIGHT=20 BORDER=0></A></TD>\n";
# echo "        <TD>\n";
echo "            <A HREF=\"http://www.osb.hu/igenaptar/\"\n";
echo "                ONMOUSEOVER=\"changeImages('nav_hor_05', '/img/nav_hor_05-nav_hor_06_over.gif', 'nav_hor_06', '/img/nav_hor_06-over.gif'); return true;\"\n";
echo "                ONMOUSEOUT=\"changeImages('nav_hor_05', '/img/nav_hor_05.gif', 'nav_hor_06', '/img/nav_hor_06.gif'); return true;\">\n";
echo "                <IMG NAME=\"nav_hor_06\" SRC=\"/img/nav_hor_06.gif\" WIDTH=45 HEIGHT=20 BORDER=0></A></TD>\n";
echo "    </TR>\n";
echo "</TABLE>\n";

echo "</td>\n";
echo"      <td background='/img/hmenubg.jpg' width='91'>&nbsp;</td>\n";
echo"    </tr>\n";
echo"    </table>\n";
}
...
function leftmenu(){
  ...
  leftmenuentry("Fórum","/forum.php");
  leftmenuentry("Hírek","/hirek.php");
  leftmenuentry("Naptár","/naptar.php");
  leftmenugroupfoot();
  leftmenupause();
  leftmenugrouphead();
...
echo"                      <a href='http://www.kereszteny.hu/kurir' class='menulink'>Magyar Kurir</a>";
echo"                      <span class='feher'> - </span>";
echo"                      <a href='http://www.kereszteny.hu/mkie' class='menulink'>MKIE</a>";
echo"                      <span class='feher'> 2002.<br>Minden jog fenntartva.</span>";
echo"                      </td>\n";
echo"                    </tr>\n";
echo"                    </table>\n";
echo"                  </td>\n";
...
echo"        <span class='alap'>Tartalmi kérdések: </span> <a href='mailto:humk@hcbc.hu' class='link'>Info</a><span class='alap'> - Technikai problémák: </span> <a href='mailto:wmaster@katolikus.hu' class='link'>Webmaster</a><br>\n";
...
echo"          <table border='0' cellpadding='0' cellspacing='0' width='590'>\n";
echo"          <tr>\n";
echo"            <td width='25'></td>\n";
echo"            <td width='670'>\n";
echo"            <table border='0' cellpadding='0' cellspacing='0' width='590'>\n";
