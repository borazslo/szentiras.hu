...
if (!empty($title)) {
  $titlestring = "Magyar Keresztény Internet Egyesület - $title\n";
} else {
  $titlestring = "Magyar Keresztény Internet Egyesület\n";
}
...
echo"        <tr>\n";
echo"          <td>\n";
echo"          <img src='/img/mkielogo.jpg' width='690' height='108' align='middle' alt='Logo'>\n";
echo"          </td></tr></table>\n";
echo"      </td>\n";
echo"   </tr>\n";
echo"   </table>\n";
...
echo"      <span class='feher'>&nbsp;&nbsp;&nbsp;Magyar Keresztény Internet Egyesület</span>";
echo"      </td>\n";
...
echo"        <span class='alap'>Kérdések és megjegyzések:</span> <a href='mailto:mkie@kereszteny.hu' class='link'>mkie@kereszteny.hu</a>\n";
echo"        </td>\n";
echo"        </tr></table></td>";
echo"      </tr>\n";
...
function mkieleftmenu(){
  leftmenuhead();
  leftmenugrouphead();
  leftmenuentry("Bemutatkozás","/mkie");
  leftmenuentry("Alapszabály","/mkie/alapsz.php");
  leftmenuentry("Elnökség","/mkie/elnokseg.php");
  leftmenuentry("Beszámolók","/mkie/beszamolok.php");
  leftmenuentry("Tagfelvétel","/mkie/tagfel.php");
  leftmenuentry("Projektek","/mkie/projektek.php");
  leftmenugroupfoot();
  leftmenupause();
  leftmenugrouphead();
  leftmenuentry("Konferencia","/mkie/konf");
  leftmenugroupfoot();
  leftmenupause();
  leftmenugrouphead();
  leftmenuentry("Portál","/");
  leftmenugroupfoot();
  leftmenufoot();
}
